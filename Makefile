...
all: library read_lock read_lock_sleep1 read_lock_sleep2 write_lock fork_read_lock test1
...
clean:
	rm -rf library build/*.o read_lock read_lock_sleep1 read_lock_sleep2 write_lock fork_read_lock test1 fichier_verrous
